...
//        }
//        if (accountServiceImpl.findAccountByName(account.getName()) == null &&
//                accountServiceImpl.findAccountByEmail(account.getEmail()) == null) {
...
//                accountServiceImpl.save(accountCreate);
...
//            }
//        } else if (accountServiceImpl.findAccountByName(account.getName()) != null) {
